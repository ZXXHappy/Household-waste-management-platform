...
public class TokenUtils {
    ...
    private static CommunityAdminService staticCommunityAdminService;

    @PostConstruct
    public void init() {
        staticAdminService = adminService;
        staticUserService = userService;
        staticCommunityAdminService = communityAdminService;
    }
    ...
    public static Account getCurrentUser() {
        try {
            ...
            } else if (RoleEnum.COMMUNITY.name().equals(role)) {
                return staticCommunityAdminService.selectById(userId);
            }
        } catch (Exception e) {
