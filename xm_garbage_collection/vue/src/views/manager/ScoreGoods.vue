<template>
  <div>
    <div class="card" style="margin-bottom: 5px">
      <el-input v-model="data.name" prefix-icon="Search" style="width: 240px; margin-right: 10px" placeholder="请输入物品名称查询"></el-input>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="num" label="剩余可兑换数量"></el-table-column>
        <el-table-column prop="unit" label="计量单位"></el-table-column>
        <el-table-column prop="score" label="单个积分"></el-table-column>
    ...
    <el-dialog title="物品信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="90px" style="padding: 20px">
        <el-form-item prop="name" label="物品名称">
          <el-input v-model="data.form.name" placeholder="请输入物品名称"></el-input>
        </el-form-item>
        ...
        <el-form-item prop="num" label="剩余数量">
          <el-input-number style="width: 200px" :min="1" v-model="data.form.num" placeholder="请输入剩余可兑换数量"></el-input-number>
        </el-form-item>
        <el-form-item prop="unit" label="计量单位">
          <el-input v-model="data.form.unit" placeholder="请输入计量单位"></el-input>
        </el-form-item>
        <el-form-item prop="score" label="单个积分">
          <el-input-number :min="1" v-model="data.form.score" placeholder="请输入单个积分"></el-input-number>
        </el-form-item>
      </el-form>
      <template #footer>
